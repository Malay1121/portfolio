...
class MobileHelloScreen extends StatefulWidget {
  MobileHelloScreen({super.key, required this.controller});
  HelloController controller;
  @override
  State<MobileHelloScreen> createState() => _MobileHelloScreenState();
}

class _MobileHelloScreenState extends State<MobileHelloScreen> {
  @override
